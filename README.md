...
[Quick Start](#-quick-start) · [Features](#-what-it-does) · [Supported Platforms](#%EF%B8%8F-supported-platforms) · [Parameters](#-parameters) · [Security Model](#%EF%B8%8F-security-model) · [Exit Codes](#-exit-codes) · [Contributing](#-contributing)
